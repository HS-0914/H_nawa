...
categorys = ["CPU", "메인보드", "메모리", "그래픽카드", "SSD", "HDD", "케이스", "파워"]
...
async def crawl_all():
    while True:
        ...
        print("크롤링 종료. 30분 뒤 다시 크롤링")
        await asyncio.sleep(60 * 60)  # 60분마다 크롤링 반복
...
def get_parts(category: str):
    ...
    return {"category": category, "data": results, "lens": lens}
